...
- l'autosave local ;
- la préparation de cadres rédactionnels ;
- l'analyse qualité ;
...
- Ajouter des tests UI ciblés sur les chemins cadre, preview, score et export.

## Tests à faire après modification

- Ouvrir `/admin/studio-editorial`.
- Changer de mode studio.
- Préparer un cadre rédactionnel et un cadre approfondi.
